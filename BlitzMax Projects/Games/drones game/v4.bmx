...
Type TLevel
	...
	Function Create:TLevel()
		...
		Local lvlgen:LEVEL_GENERATOR = LEVEL_GENERATOR.Create(10,10)
...
Type TRoom_Item_Door Extends TRoom_Item
...
Type TRoom_Item_Airlock Extends TRoom_Item
	Field id:Int = -1
...
Type TPlayer Extends TMob
	...
	Field last_room_item:TRoom_Item
	
	Field navigate_end_room:LEVEL_GENERATOR_ROOM
	Field navigate_next_room:LEVEL_GENERATOR_ROOM
	Field navigate_next_step:TRoom_Item' airlock or door that connects current to next room
