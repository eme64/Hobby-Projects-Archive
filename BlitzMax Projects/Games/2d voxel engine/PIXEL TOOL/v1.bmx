...
Const SCALE_FACTOR:Int = 4 ' 3 would be the goal, if can make it with buffers...
Const GENERATION_MODE:Int = 1
...
Function canvas_add_bottom(src:TPixmap[], a:Int,b:Int)
...
Function canvas_add_right(src:TPixmap[], a:Int,b:Int)
...
Function canvas_add_left(src:TPixmap[], a:Int,b:Int)
	For Local i:Int = 0 To src.length-1
		Local rnd_offset:Int = Rand(0,2^6)
		...
		Else
			...
			Select GENERATION_MODE
				...
				Case 1 ' -------------------------------------------------------- SIMPLE BORDERS
					...
					canvas_add_top(canvas, BDR_MIN,BDR_MAX)
					...
					canvas_add_left(canvas, BDR_MIN,BDR_MAX)
					...
					canvas_add_right(canvas, BDR_MIN,BDR_MAX)
					...
					canvas_add_bottom(canvas, BDR_MIN,BDR_MAX)
