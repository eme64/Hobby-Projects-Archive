...
Function hilfe_menu()
	...
	Repeat
		...
		Text 400,240,"steuert man die fallenden Blöcke.",1,1
		Text 400,310,"Das Ziel ist es möglichst viele Blöcke aufzulösen,",1,1
		Text 400,350,"wobei mindestens 4 der gleichen Farbe beieinander sein müssen.",1,1
		
		Text 400,420,"Tipp: Versuche dass möglichst viele Blöcke gleichzeitig zerplatzen,",1,1
