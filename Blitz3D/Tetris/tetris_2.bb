...
Repeat
	...
	For y=0 To 12
		For x=0 To 9
			If feld(x,y,0)<>0 And feld(x,y,3)=0 Then
				For yy=0 To 12
					For xx=0 To 9
						feld(xx,yy,4)=0
					Next
				...
				Repeat
					...
					For yy=0 To 12
						For xx=0 To 9
							If feld(xx,yy,3)=0 And feld(x,y,0)=feld(xx,yy,0) And feld(xx,yy,4)=0 Then
								feld(xx,yy,4)=1
							End If
						Next
					Next
					...
					For yy=0 To 12
						For xx=0 To 9
							If feld(xx,yy,0)<>0 And feld(xx,yy,3)=0 And feld(x,y,0)=feld(xx,yy,0) And feld(xx,yy,4)=1 Then
								antw=0
								If xx<9 Then
									If (feld(xx+1,yy,4)=1 Or feld(xx+1,yy,4)=2) And feld(xx+1,yy,3)=0 Then antw=1
								End If
								If xx>0 Then
									If (feld(xx-1,yy,4)=1 Or feld(xx-1,yy,4)=2) And feld(xx-1,yy,3)=0 Then antw=1
								End If
								If yy<12 Then
									If (feld(xx,yy+1,4)=1 Or feld(xx,yy+1,4)=2) And feld(xx,yy+1,3)=0 Then antw=1
								End If
								If yy>0 Then
									If (feld(xx,yy-1,4)=1 Or feld(xx,yy-1,4)=2) And feld(xx,yy-1,3)=0 Then antw=1
								End If
	...
	For i=0 To 50 Step 8
		...
		For y=0 To 9
			...
			Next
		Next
		If step_sprint=2 Then Delay 50
		Flip
	Next
