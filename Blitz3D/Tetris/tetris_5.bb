...
Function options_menu()
	...
	Repeat
		...
		i=0
		i=i+1
		If draw_buton(200,100*i,300,m_x,m_y,"ANFÄNGER") And mh_1 Then
			anzahl_rects=3
			spiel_exist=0
		End If
		...
		i=i+1
		If draw_buton(200,100*i,300,m_x,m_y,"ÜBERMENSCH") And mh_1 Then
			anzahl_rects=8
			spiel_exist=0
		End If
		
		i=i+1
		If draw_buton(200,100*i,300,m_x,m_y,"Hauptmenü") And mh_1 Then antw=1
