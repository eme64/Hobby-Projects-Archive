...
Function main_menu()
	Repeat
		...
		Repeat
			...
			SetFont arial_50
			Color 255,255,255
			Text 400,30,"HAUPTMENU",1,1
			antw=0
			i=0
			i=i+1
			antw=antw+draw_buton(250,100*i,300,m_x,m_y,"neues Spiel starten")*1
			i=i+1
			If spiel_exist=1 Then antw=antw+draw_buton(250,100*i,300,m_x,m_y,"Weiterspielen")*2
			i=i+1
			antw=antw+draw_buton(250,100*i,300,m_x,m_y,"Optionen")*3
			i=i+1
			antw=antw+draw_buton(250,100*i,300,m_x,m_y,"Spielanleitung")*4
			i=i+1
			antw=antw+draw_buton(250,100*i,300,m_x,m_y,"Beenden")*5
...
Function options_menu()
	...
	Repeat
		...
		;start_level
		;spiel_exist=0
		;draw_buton(x,y,l,m_x,m_y,"ANFÄNGER")
		SetFont arial_50
		Color 255,0,0
		Text 400,30,"OPTIONEN",1,1
		
		
		Color 255,255,255
		SetFont arial_30
		Text 400,115,"Level",1,1
		
		SetFont arial_50
		Text 400,165,start_level,1,1
		
		If draw_buton(250,140,0,m_x,m_y,"-",start_level<=1) And mh_1 Then start_level=start_level-1
		If draw_buton(450,140,0,m_x,m_y,"+",start_level>=anzahl_levels) And mh_1 Then start_level=start_level+1
